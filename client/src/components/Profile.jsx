...
//   return (
//     <div className={`min-h-screen ${isDarkMode ? 'dark' : ''} bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-200 transition-colors duration-300`}>
//       <header className="w-full py-6 px-4 sm:px-8 bg-gray-200 dark:bg-gray-800 flex flex-col items-center border-b border-gray-300">
//         <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-gray-100">Profile</h1>
//       </header>
//       <main className="flex-grow p-4 sm:p-8">
//         <div className="mb-4">
//           <label htmlFor="category-select" className="block text-lg mb-2">Select Category:</label>
...
//             value={selectedCategory}
//             onChange={(e) => setSelectedCategory(e.target.value)}
//             className="w-full h-12 px-4 py-2 rounded-lg font-bold transition-colors duration-300 bg-gray-200 dark:bg-gray-700 text-black dark:text-gray-200"
//           >
//             <option value="All">All</option>
...
//         {notification && (
//           <div className="p-4 mb-4 rounded-lg border bg-green-100 dark:bg-green-800 text-green-800 dark:text-green-300 border-green-300 dark:border-green-600">
//             {notification}
//           </div>
//         )}
...
//           <ul className="space-y-4">
//             {(selectedCategory === 'Favorites' ? favorites : filteredNews).map(newsItem => (
//               <li key={newsItem.id} className="p-4 rounded-lg shadow-lg bg-white dark:bg-gray-800 transition-colors duration-300">
//                 <h3 className="text-xl font-semibold">{newsItem.title}</h3>
//                 <p className="text-base text-gray-700 dark:text-gray-400">{newsItem.description}</p>
//                 <button
//                   onClick={() => handleToggleFavorite(newsItem)}
//                   className="text-yellow-500 hover:text-yellow-600"
//                 >
...
//       <aside className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-gray-200 dark:bg-gray-800 flex justify-around border-t border-gray-300">
//         <button
//           onClick={handleProfileCardPage}
//           className="px-4 py-2 rounded-lg font-bold transition-colors duration-300 bg-blue-400 hover:bg-blue-300 text-black dark:bg-blue-600 dark:hover:bg-blue-500 dark:text-white"
//         >
//           Profile Card
//         </button>
//         <button
//           onClick={handleFavoritesPage}
//           className="px-4 py-2 rounded-lg font-bold transition-colors duration-300 bg-green-500 hover:bg-green-600 text-white"
//         >
//           Favorite News
//         </button>
//         <button
//           onClick={handleLogOut}
//           className="px-4 py-2 rounded-lg font-bold transition-colors duration-300 bg-red-500 hover:bg-red-600 text-white"
//         >
//           Log Out
//         </button>
//         <button
//           onClick={handleToggleDarkMode}
//           className="px-4 py-2 rounded-lg font-bold transition-colors duration-300 bg-gray-300 dark:bg-gray-600 dark:hover:bg-gray-500 text-black dark:text-white"
//         >
//           {isDarkMode ? 'Light Mode' : 'Dark Mode'}
//         </button>
//       </aside>

//       <footer className="bg-blue-100 dark:bg-gray-900 text-center py-8 mt-auto text-black dark:text-white">
//         <p className="text-base md:text-lg">
//           Stay informed with Trending News, your trusted source for timely and accurate news coverage. Explore breaking stories, in-depth analysis, and stay connected with the world around you.
//         </p>
//         <p className="text-base md:text-lg mt-4">Follow us for the latest updates:</p>
//         <div className="mt-4 flex justify-center flex-wrap">
//           <a href="https://www.facebook.com/login/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline mr-4">Facebook</a>
//           <a href="https://www.instagram.com/accounts/login/" target="_blank" rel="noopener noreferrer" className="text-pink-600 dark:text-pink-400 hover:underline">Instagram</a>
//         </div>
//         <p className="text-sm mt-8">&copy; <span id="year">{new Date().getFullYear()}</span> Trending News. All rights reserved.</p>
//       </footer>
//     </div>
